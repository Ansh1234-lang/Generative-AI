...
if not api_key:
    st.error("⚠️ Please enter your Groq API key in the sidebar before continuing.")
    st.stop()
...
user_query=st.chat_input(placeholder="Ask anything from data base")
...
if user_query:
    ...
    with st.chat_message("assistant"):
        streamli_callback=StreamlitCallbackHandler(st.container())
        response=agent.run(user_query,callbacks=[streamli_callback])
